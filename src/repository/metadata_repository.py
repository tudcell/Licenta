"""Repository adapter around MetadataStore persistence."""
...
class MetadataRepository:
    ...
    def search_transactions(
        ...
        return self._store.search_transactions(
            sender=sender,
            tx_type=tx_type,
            status=status,
            flagged=flagged,
    ...
    def update_transaction_state(
        ...
        return self._store.update_transaction_state(
